...
input_file = 'wbe-server-access-log.txt'
extracted_file = 'extracted-data.txt'
transformed_file = 'transformed.txt'
output_file = 'capitalized.csv'
...
default_args = {
    'owner': 'Nguyen Dai First DAG',
    'start_date': days_ago(0),
    'email': ['2251052010dai@ou'],
    'retries': 1,
...
# Define the DAG
dag = DAG(
    'webdata_crawling_with_DAG',
    default_args=default_args,
    description='My first DAG',
    schedule_interval=timedelta(days=1),
)

# Download file content using PyOperator
